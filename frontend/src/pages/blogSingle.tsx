...
export const BlogSingle=()=>{
    ...
    if(loading){
        return(
        <div role="status">
        <svg aria-hidden="true" className="mx-auto w-20 h-screen text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
