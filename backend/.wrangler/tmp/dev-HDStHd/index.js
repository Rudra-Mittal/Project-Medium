...
// .wrangler/tmp/bundle-RIeqi7/checked-fetch.js
  ...
  "node_modules/@prisma/client/runtime/edge.js"(exports, module) {
    ...
    var hi = Se((rt) => {
      ...
      var ri = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), da = ri((e) => {
        ...
        function g(C) {
          var A, D = a(C), O = D[0], B = D[1], M = new n(l(C, O, B)), I = 0, X = B > 0 ? O - 4 : O, L;
          for (L = 0; L < X; L += 4)
        ...
        function x(C, A, D) {
          for (var O, B = [], M = A; M < D; M += 3)
            O = (C[M] << 16 & 16711680) + (C[M + 1] << 8 & 65280) + (C[M + 2] & 255), B.push(h(O));
          return B.join("");
        }
        function S(C) {
          for (var A, D = C.length, O = D % 3, B = [], M = 16383, I = 0, X = D - O; I < X; I += M)
    ...
    var io = Se((Mh, cu) => {
      cu.exports = { name: "@prisma/engines-version", version: "5.14.0-25.e9771e62de70f79a5e1c604a2d7c8e2a0a874b48", main: "index.js", types: "index.d.ts", license: "Apache-2.0", author: "Tim Suchanek <suchanek@prisma.io>", prisma: { enginesVersion: "e9771e62de70f79a5e1c604a2d7c8e2a0a874b48" }, repository: { type: "git", url: "https://github.com/prisma/engines-wrapper.git", directory: "packages/engines-version" }, devDependencies: { "@types/node": "18.19.32", typescript: "4.9.5" }, files: ["index.js", "index.d.ts"], scripts: { build: "tsc -d" } };
    });
    var oo = Se(() => {
      "use strict";
      d();
    ...
    var Un = Se((a2, ys) => {
      ...
      ys.exports = function() {
        ...
        return function(t, r) {
          ...
          if (i -= s, o -= s, i === 0 || o < 3)
            return o;
          var a = 0, u, l, g, h, x, S, C, A, D, O, B, M, I = [];
          for (u = 0; u < i; u++)
            I.push(u + 1), I.push(t.charCodeAt(s + u));
          for (var X = I.length - 1; a < o - 3; )
            for (D = r.charCodeAt(s + (l = a)), O = r.charCodeAt(s + (g = a + 1)), B = r.charCodeAt(s + (h = a + 2)), M = r.charCodeAt(s + (x = a + 3)), S = a += 4, u = 0; u < X; u += 2)
              C = I[u], A = I[u + 1], l = e(C, l, g, D, A), g = e(l, g, h, O, A), h = e(g, h, x, B, A), S = e(h, x, S, M, A), I[u] = S, x = h, h = g, g = l, l = C;
          for (; a < o; )
...
`);
    ...
    R.cosine = R.cos = function() {
      ...
      return r.d ? r.d[0] ? (e = n.precision, t = n.rounding, n.precision = e + Math.max(r.e, r.sd()) + N, n.rounding = 1, r = yu(n, To(n, r)), n.precision = e, n.rounding = t, k(Ce == 2 || Ce == 3 ? r.neg() : r, e, t, true)) : new n(1) : new n(NaN);
    };
    R.cubeRoot = R.cbrt = function() {
      ...
      return F = true, k(n, e, h.rounding, t);
    };
    ...
    R.inverseTangent = R.atan = function() {
      ...
      for (F = false, t = Math.ceil(a / N), n = 1, u = l.times(l), s = new g(l), i = l; e !== -1; )
        if (i = i.times(u), o = s.minus(i.div(n += 2)), i = i.times(u), s = o.plus(i.div(n += 2)), s.d[t] !== void 0)
          for (e = t; s.d[e] === o.d[e] && e--; )
            ;
      return r && (s = s.times(2 << r - 1)), F = true, k(s, g.precision = h, g.rounding = x, true);
    };
    R.isFinite = function() {
      return !!this.d;
    };
    ...
    R.logarithm = R.log = function(e) {
      ...
      if (F = false, a = h + S, s = Oe(l, a), n = t ? Er(g, a + 10) : Oe(e, a), u = q(s, n, a, 1), Lt(u.d, i = h, x))
        do
    ...
    R.minus = R.sub = function(e) {
      ...
      if (r = te(e.e / N), g = te(S.e / N), l = l.slice(), o = g - r, o) {
        for (h = o < 0, h ? (t = l, o = -o, s = x.length) : (t = x, r = g, s = l.length), n = Math.max(Math.ceil(a / N), s) + 2, o > n && (o = n, t.length = 1), t.reverse(), n = o; n--; )
          t.push(0);
        t.reverse();
      } else {
      ...
      for (; l[0] === 0; l.shift())
        --r;
      return l[0] ? (e.d = l, e.e = xr(l, r), F ? k(e, a, u) : e) : new C(u === 3 ? -0 : 0);
    };
    R.modulo = R.mod = function(e) {
      var t, r = this, n = r.constructor;
      return e = new n(e), !r.d || !e.s || e.d && !e.d[0] ? new n(NaN) : !e.d || r.d && !r.d[0] ? k(new n(r), n.precision, n.rounding) : (F = false, n.modulo == 9 ? (t = q(r, e.abs(), 0, 3, 1), t.s *= e.s) : t = q(r, e, 0, n.modulo, 1), t = t.times(e), F = true, r.minus(t));
    };
    ...
    R.sine = R.sin = function() {
      var e, t, r = this, n = r.constructor;
      return r.isFinite() ? r.isZero() ? new n(r) : (e = n.precision, t = n.rounding, n.precision = e + Math.max(r.e, r.sd()) + N, n.rounding = 1, r = Eu(n, To(n, r)), n.precision = e, n.rounding = t, k(Ce > 2 ? r.neg() : r, e, t, true)) : new n(NaN);
    };
    R.squareRoot = R.sqrt = function() {
      var e, t, r, n, i, o, s = this, a = s.d, u = s.e, l = s.s, g = s.constructor;
      if (l !== 1 || !a || !a[0])
        return new g(!l || l < 0 && (!a || a[0]) ? NaN : a ? s : 1 / 0);
      for (F = false, l = Math.sqrt(+s), l == 0 || l == 1 / 0 ? (t = Z(a), (t.length + u) % 2 == 0 && (t += "0"), l = Math.sqrt(t), u = te((u + 1) / 2) - (u < 0 || u % 2), l == 1 / 0 ? t = "5e" + u : (t = l.toExponential(), t = t.slice(0, t.indexOf("e") + 1) + u), n = new g(t)) : n = new g(l.toString()), r = (u = g.precision) + 3; ; )
      ...
      return F = true, k(n, u, g.rounding, e);
    };
    ...
    R.times = R.mul = function(e) {
      ...
      for (r = te(g.e / N) + te(e.e / N), u = x.length, l = S.length, u < l && (o = x, x = S, S = o, s = u, u = l, l = s), o = [], s = u + l, n = s; n--; )
        o.push(0);
      for (n = l; --n >= 0; ) {
        for (t = 0, i = u + n; i > n; )
      ...
      for (; !o[--s]; )
        o.pop();
      return t ? ++r : o.shift(), e.d = o, e.e = xr(o, r), F ? k(e, h.precision, h.rounding) : e;
    };
    ...
    R.toFraction = function(e) {
      ...
      if (!C)
        return new A(S);
      if (l = r = new A(1), n = u = new A(0), t = new A(n), o = t.e = bo(C) - S.e - 1, s = o % N, t.d[0] = H(10, s < 0 ? N + s : s), e == null)
        e = o > 0 ? t : l;
      else {
      ...
      return i = q(e.minus(r), n, 0, 1, 1), u = u.plus(i.times(l)), r = r.plus(i.times(n)), u.s = l.s = S.s, x = q(l, n, o, 1).minus(S).abs().cmp(q(u, r, o, 1).minus(S).abs()) < 1 ? [l, n] : [u, r], A.precision = g, F = true, x;
    };
    ...
    R.toNearest = function(e, t) {
      ...
      return e.d[0] ? (F = false, r = q(r, e, 0, t, 1).times(e), F = true, k(r)) : (e.s = r.s, r = e), r;
    };
    R.toNumber = function() {
      return +this;
    };
    ...
    R.toPower = R.pow = function(e) {
      ...
      return r = H(+a, l), t = r == 0 || !isFinite(r) ? te(l * (Math.log("0." + Z(a.d)) / Math.LN10 + a.e + 1)) : new u(r + "").e, t > u.maxE + 1 || t < u.minE - 1 ? new u(t > 0 ? s / 0 : 0) : (F = false, u.rounding = a.s = 1, r = Math.min(12, (t + "").length), i = Pn(e.times(Oe(a, n + r)), n), i.d && (i = k(i, n + 5, 1), Lt(i.d, n, o) && (t = n + 10, i = k(Pn(e.times(Oe(a, t + r)), t), t + 5, 1), +Z(i.d).slice(n + 1, n + 15) + 1 == 1e14 && (i = k(i, n + 1, 0)))), i.s = s, F = true, u.rounding = o, k(i, n, o));
    };
    ...
    var q = function() {
      ...
      return function(n, i, o, s, a, u) {
        var l, g, h, x, S, C, A, D, O, B, M, I, X, L, Ye, Be, fe, $e, Q, Re, qe = n.constructor, Ze = n.s == i.s ? 1 : -1, ee = n.d, U = i.d;
        if (!ee || !ee[0] || !U || !U[0])
          return new qe(!n.s || !i.s || (ee ? U && ee[0] == U[0] : !U) ? NaN : ee && ee[0] == 0 || !U ? Ze * 0 : Ze / 0);
        for (u ? (S = 1, g = n.e - i.e) : (u = pe, S = N, g = te(n.e / S) - te(i.e / S)), Q = U.length, fe = ee.length, O = new qe(Ze), B = O.d = [], h = 0; U[h] == (ee[h] || 0); h++)
          ;
        if (U[h] > (ee[h] || 0) && g--, o == null ? (L = o = qe.precision, s = qe.rounding) : a ? L = o + (n.e - i.e) + 1 : L = o, L < 0)
          ...
          if (L = L / S + 2 | 0, h = 0, Q == 1) {
            ...
            for (x = u / (U[0] + 1) | 0, x > 1 && (U = e(U, x, u), ee = e(ee, x, u), Q = U.length, fe = ee.length), Be = Q, M = ee.slice(0, Q), I = M.length; I < Q; )
              M[I++] = 0;
            Re = U.slice(), Re.unshift(0), $e = U[0], U[1] >= u / 2 && ++$e;
            do
              x = 0, l = t(U, M, Q, I), l < 0 ? (X = M[0], Q != I && (X = X * u + (M[1] || 0)), x = X / $e | 0, x > 1 ? (x >= u && (x = u - 1), A = e(U, x, u), D = A.length, I = M.length, l = t(A, M, D, I), l == 1 && (x--, r(A, Q < D ? Re : U, D, u))) : (x == 0 && (l = x = 1), A = U.slice()), D = A.length, D < I && A.unshift(0), r(M, A, I, u), l == -1 && (I = M.length, l = t(U, M, Q, I), l < 1 && (x++, r(M, Q < I ? Re : U, I, u))), I = M.length) : l === 0 && (x++, M = [0]), B[h++] = x, l && M[0] ? M[I++] = ee[Be] || 0 : (M = [ee[Be]], I = 1);
      ...
      e:
        if (t != null) {
          ...
          for (i = 1, a = h[0]; a >= 10; a /= 10)
            i++;
          if (o = t - i, o < 0)
            o += N, s = t, g = h[x = 0], u = g / H(10, i - s - 1) % 10 | 0;
          ...
          if (o == 0 ? (h.length = x, a = 1, x--) : (h.length = x + 1, a = H(10, N - o), h[x] = s > 0 ? (g / H(10, i - s) % H(10, s) | 0) * a : 0), l)
            for (; ; )
              if (x == 0) {
    ...
    function Er(e, t, r) {
      if (t > hu)
        throw F = true, r && (e.precision = r), Error(ho);
    ...
    function Pn(e, t) {
      ...
      for (t == null ? (F = false, u = C) : u = t, a = new x(0.03125); e.e > -2; )
        e = e.times(a), h += 5;
        ...
        if (o = k(o.times(e), u, 1), r = r.times(++g), a = s.plus(q(o, r, u, 1)), Z(a.d).slice(0, u) === Z(s.d).slice(0, u)) {
          ...
          if (t == null)
            if (l < 3 && Lt(s.d, u - n, S, l))
              ...
              return k(s, x.precision = C, S, F = true);
          else
    ...
    function Oe(e, t) {
      var r, n, i, o, s, a, u, l, g, h, x, S = 1, C = 10, A = e, D = A.d, O = A.constructor, B = O.rounding, M = O.precision;
      if (A.s < 0 || !D || !D[0] || !A.e && D[0] == 1 && D.length == 1)
        return new O(D && !D[0] ? -1 / 0 : A.s != 1 ? NaN : D ? 0 : A);
      if (t == null ? (F = false, g = M) : g = t, O.precision = g += C, r = Z(D), n = r.charAt(0), Math.abs(o = A.e) < 15e14) {
        for (; n < 7 && n != 1 || n == 1 && r.charAt(1) > 3; )
          A = A.times(e), r = Z(A.d), n = r.charAt(0), S++;
        o = A.e, n > 1 ? (A = new O("0." + r), o++) : A = new O(n + "." + r.slice(1));
      } else
        return l = Er(O, g + 2, M).times(o + ""), A = Oe(new O(n + "." + r.slice(1)), g - C).plus(l), O.precision = M, t == null ? k(A, M, B, F = true) : A;
      for (h = A, u = s = A = q(A.minus(1), A.plus(1), g, 1), x = k(A.times(A), g, 1), i = 3; ; ) {
        if (s = k(s.times(x), g, 1), l = u.plus(q(s, new O(i), g, 1)), Z(l.d).slice(0, g) === Z(u.d).slice(0, g))
          if (u = u.times(2), o !== 0 && (u = u.plus(Er(O, g + 2, M).times(o + ""))), u = q(u, new O(S), g, 1), t == null)
            if (Lt(u.d, g - C, B, a))
              O.precision = g += C, l = s = A = q(h.minus(1), h.plus(1), g, 1), x = k(A.times(A), g, 1), i = a = 1;
            else
              return k(u, O.precision = M, B, F = true);
          else
            return O.precision = M, u;
        u = l, i += 2;
      }
    }
    function vo(e) {
    ...
    function wu(e, t) {
      ...
      for (o = t.search(/p/i), o > 0 ? (u = +t.slice(o + 1), t = t.substring(2, o)) : t = t.slice(2), o = t.indexOf("."), s = o >= 0, n = e.constructor, s && (t = t.replace(".", ""), a = t.length, o = a - o, i = xo(n, new n(r), o, o * 2)), l = hr(t, r, pe), g = l.length - 1, o = g; l[o] === 0; --o)
        l.pop();
      return o < 0 ? new n(e.s * 0) : (e.e = xr(l, g), e.d = l, F = false, s && (e = q(e, i, a * 4)), u && (e = e.times(Math.abs(u) < 54 ? H(2, u) : Ge.pow(2, u))), F = true, e);
    }
    function Eu(e, t) {
      var r, n = t.d.length;
      if (n < 3)
    ...
    function pt(e, t, r, n, i) {
      ...
      for (F = false, u = r.times(r), a = new e(n); ; ) {
    ...
    function Co(e) {
      ...
      function i(o) {
        ...
        if (l.constructor = i, mo(o)) {
          l.s = o.s, F ? !o.d || o.e > i.maxE ? (l.e = NaN, l.d = null) : o.e < i.minE ? (l.e = 0, l.d = [0]) : (l.e = o.e, l.d = o.d.slice()) : (l.e = o.e, l.d = o.d ? o.d.slice() : o.d);
          return;
        }
        if (u = typeof o, u === "number") {
          ...
          if (o < 0 ? (o = -o, l.s = -1) : l.s = 1, o === ~~o && o < 1e7) {
            for (s = 0, a = o; a >= 10; a /= 10)
              s++;
            F ? s > i.maxE ? (l.e = NaN, l.d = null) : s < i.minE ? (l.e = 0, l.d = [0]) : (l.e = s, l.d = [o]) : (l.e = s, l.d = [o]);
            return;
          } else if (o * 0 !== 0) {
    ...
    function tl() {
      ...
      for (F = false; r.s && ++e < t.length; )
        r = r.plus(t[e]);
      return F = true, k(r, this.precision, this.rounding);
    }
    function rl(e) {
...
To solve this, provide the connection string directly: https://pris.ly/d/cloudflare-datasource-url`, n) : new G(`error: Environment variable not found: ${s.fromEnvVar}.`, n);
    ...
    f();
    m();
    var fs = { "@prisma/debug": "workspace:*", "@prisma/engines-version": "5.14.0-25.e9771e62de70f79a5e1c604a2d7c8e2a0a874b48", "@prisma/fetch-engine": "workspace:*", "@prisma/get-platform": "workspace:*" };
    d();
    c();
    p();
    f();
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "/home/jarvis/Development/Project-medium/backend/node_modules/@prisma/client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
...
// node_modules/@rudra_mittal/input-validation/dist/index.js
var require_dist = __commonJS({
  "node_modules/@rudra_mittal/input-validation/dist/index.js"(exports) {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.getBlog = exports.updateBlog = exports.createBlog = exports.signin = exports.signup = void 0;
    ...
    exports.getBlog = zod_1.z.object({
      skip: zod_1.z.number().min(0),
      take: zod_1.z.number().min(1)
    });
  }
});

// .wrangler/tmp/bundle-RIeqi7/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-RIeqi7/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
// src/routes/user.ts
var import_input_validation = __toESM(require_dist());
var userRouter = new Hono2();
userRouter.use("*", async (c, next) => {
  const prisma = await new import_edge.PrismaClient({
...
userRouter.post("/signup", async (c) => {
  const { error } = import_input_validation.signup.safeParse(await c.req.json());
  if (error) {
    c.status(400);
  ...
  try {
    ...
    c.status(401);
    return c.json({ error: error2.message });
  }
});
userRouter.post("/signin", async (c) => {
  const { error } = import_input_validation.signin.safeParse(await c.req.json());
  if (error) {
    c.status(400);
    return c.json({ error: error.message });
  }
...
var import_input_validation2 = __toESM(require_dist());
var blogRouter = new Hono2();
blogRouter.use("*", async (c, next) => {
  const prisma = await new import_edge2.PrismaClient({
    datasourceUrl: c.env.DATABASE_URL
  }).$extends(withAccelerate());
  c.set("prisma", prisma);
  return next();
...
blogRouter.use("/", async (c, next) => {
  ...
  const payload = await verify2(jwt2, c.env.JWT_SECRET);
  if (!payload) {
    c.status(401);
    return c.json({ error: "unauthorized" });
  }
...
blogRouter.post("/", async (c) => {
  ...
  const prisma = c.get("prisma");
  const { error } = import_input_validation2.createBlog.safeParse(await c.req.json());
  if (error) {
    c.status(400);
    return c.json({ error: error.message });
  }
...
blogRouter.put("/", async (c) => {
  const { error } = import_input_validation2.updateBlog.safeParse(await c.req.json());
  if (error) {
    c.status(400);
    return c.json({ error: error.message });
  }
...
blogRouter.post("/bulk", async (c) => {
  const { error } = import_input_validation2.getBlog.safeParse(await c.req.json());
  if (error) {
    c.status(400);
    return c.json({ error: error.message });
  }
